-file(
    "/home/joaohf/beamtools/4.1.1-erlang-25.1.2-elixir-1.14.2/sysroots/x86_64-pokysdk-linux/usr/lib/erlang/lib/parsetools-2.4.1/include/leexinc.hrl",
    0
).
...
-module(zl30702_lexer).

-export([string/1, string/2, token/2, token/3, tokens/2, tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/home/joaohf/work/projetos/eparser/src/zl30702_lexer.xrl", 22).

from_hex([$0, $x | Rest]) ->
    erlang:list_to_integer(Rest, 16).

to_regname([$;, $\s, $\s | Regname]) -> Regname.
...
-file("/home/joaohf/work/projetos/eparser/src/zl30702_lexer.erl", 315).
yystate() -> 10.
...
yystate(11, Ics, Line, Tlen, _, _) ->
    {3, Tlen, Ics, Line, 11};
yystate(10, [88 | Ics], Line, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Tlen + 1, Action, Alen);
yystate(10, [87 | Ics], Line, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Tlen + 1, Action, Alen);
...
yystate(5, [C | Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(5, Ics, Line, Tlen + 1, 4, Tlen);
yystate(5, [C | Ics], Line, Tlen, _, _) when C >= 60, C =< 62 ->
    yystate(9, Ics, Line, Tlen + 1, 4, Tlen);
...
yystate(2, [13 | Ics], Line, Tlen, _, _) ->
    yystate(9, Ics, Line, Tlen + 1, 5, Tlen);
yystate(2, [8 | Ics], Line, Tlen, _, _) ->
    yystate(9, Ics, Line, Tlen + 1, 5, Tlen);
yystate(2, [9 | Ics], Line, Tlen, _, _) ->
    yystate(9, Ics, Line, Tlen + 1, 5, Tlen);
yystate(2, [10 | Ics], Line, Tlen, _, _) ->
    yystate(9, Ics, Line + 1, Tlen + 1, 5, Tlen);
yystate(2, [C | Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(9, Ics, Line, Tlen + 1, 5, Tlen);
...
yystate(1, [C | Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(9, Ics, Line, Tlen + 1, 5, Tlen);
yystate(1, [C | Ics], Line, Tlen, _, _) when C >= 60, C =< 62 ->
    yystate(9, Ics, Line, Tlen + 1, 5, Tlen);
...
-file("/home/joaohf/work/projetos/eparser/src/zl30702_lexer.xrl", 10).
yyaction_0() ->
    skip_token.

-compile({inline, yyaction_1/2}).
-file("/home/joaohf/work/projetos/eparser/src/zl30702_lexer.xrl", 11).
yyaction_1(TokenChars, TokenLine) ->
    {token, {command, TokenLine, command(TokenChars)}}.

-compile({inline, yyaction_2/2}).
-file("/home/joaohf/work/projetos/eparser/src/zl30702_lexer.xrl", 12).
yyaction_2(TokenChars, TokenLine) ->
    {token, {value, TokenLine, from_hex(TokenChars)}}.

-compile({inline, yyaction_3/2}).
-file("/home/joaohf/work/projetos/eparser/src/zl30702_lexer.xrl", 13).
yyaction_3(TokenChars, TokenLine) ->
    {token, {time, TokenLine, list_to_integer(TokenChars)}}.

-compile({inline, yyaction_4/2}).
-file("/home/joaohf/work/projetos/eparser/src/zl30702_lexer.xrl", 14).
yyaction_4(TokenChars, TokenLine) ->
    {token, {regname, TokenLine, to_regname(TokenChars)}}.

-compile({inline, yyaction_5/0}).
-file("/home/joaohf/work/projetos/eparser/src/zl30702_lexer.xrl", 16).
yyaction_5() ->
    skip_token.

-compile({inline, yyaction_6/0}).
-file("/home/joaohf/work/projetos/eparser/src/zl30702_lexer.xrl", 17).
yyaction_6() ->
    skip_token.

-compile({inline, yyaction_7/0}).
-file("/home/joaohf/work/projetos/eparser/src/zl30702_lexer.xrl", 18).
yyaction_7() ->
    skip_token.
